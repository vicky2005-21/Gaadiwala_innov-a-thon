import SectionText1 from "./SectionText1";
    ...
    <section className={styles.section}>
      ...
      <div className={styles.row}>
        <div className={styles.col}>
          <img className={styles.colChild} alt="" src="/group-48-11.svg" />
        </div>
        <div className={styles.col1}>
          <div className={styles.sectionText}>
            <div className={styles.top}>
              ...
              <div className={styles.secondaryHeadline}>Find the Best !</div>
            </div>
            <div className={styles.paragraph}>
              Find the perfect match so it match your requirements
            </div>
          ...
          <div className={styles.sectionText1}>
            <div className={styles.top1}>
              ...
              <div className={styles.secondaryHeadline1}>Find the Best !</div>
            </div>
            <div className={styles.paragraph1}>
              Aliquam vel platea curabitur sit vestibulum egestas sit id lorem.
              Aliquet neque, dui sed eget scelerisque. Non at at venenatis
              tortor amet feugiat ullamcorper in. Odio vulputate cras vel
              lacinia turpis volutpat adipiscing. Sollicitudin at velit, blandit
              tempus nunc in.
            </div>
          ...
          <div className={styles.sectionText2}>
            <div className={styles.top2}>
              ...
              <div className={styles.secondaryHeadline2}>Find the Best !</div>
            </div>
      ...
      <button className={styles.button5}>
        ...
        <div className={styles.textContainer9}>
          <b className={styles.buttonText9}>Get Started</b>
        </div>
        <img
