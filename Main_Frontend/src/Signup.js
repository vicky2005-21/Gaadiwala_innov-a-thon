...
const saveUserData = async () => {
    ...
    formDataPayload.append('aadhaar_number', aadhaarDetails?.aadhaar_number);
    ...
    return (
        <div className="signup-form">
            ...
            {/* Already have an account link - Now at the top */}
            ...
            <form onSubmit={handleSubmit}>
                ...
                <p>Already have an account? <a href="http://localhost:3000/login">Login here</a>.</p>
                <p>{responseMessage}</p>
                {/* Already have an account link - Correctly placed at the bottom */}
                <p>Already have an account? <a href="http://localhost:3000/login">Login here</a>.</p>
            </form>
        </div>
    );
